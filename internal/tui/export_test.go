...
func (m Model) IsRefreshing() bool                { return m.isRefreshing }
func (m Model) SnapshotWrittenAt() time.Time      { return m.snapshotWrittenAt }
func (m Model) BaseStack() []*Context             { return m.baseStack() }
func (m Model) Dirty() map[domain.MRKey]time.Time { return m.dirty }
